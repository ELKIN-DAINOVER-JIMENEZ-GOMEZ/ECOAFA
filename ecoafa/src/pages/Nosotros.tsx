...
// ─── Constantes ───────────────────────────────────────────────────────────────
const OFFICE_PHONE = "310 879 5727";
const OFFICE_EMAIL = "ecoafa.sas@gmail.com";
const OFFICE_ADDRESS = "CRA 12 #93 - 78, Bogotá D.C.";
const MAPS_EMBED =
...
const valores = [
  {
    ...
    desc: "Cada proyecto busca el equilibrio entre el desarrollo y la conservación del entorno natural.",
  },
  {
    icon: "🤝",
    title: "Compromiso",
    desc: "Cumplimos con los más altos estándares técnicos y legales en cada etapa de nuestros proyectos.",
  },
  {
    icon: "🔬",
    title: "Innovación",
    desc: "Incorporamos tecnología de punta y metodologías actualizadas para entregar soluciones eficaces.",
  },
  {
    icon: "🌎",
    title: "Responsabilidad",
    desc: "Actuamos con ética y transparencia, contribuyendo positivamente al bienestar de las comunidades.",
  },
];
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl px-6">
          <p
            className="hf-0 text-xs font-bold tracking-[0.35em] uppercase mb-4"
            style={{ color: "#00AEEF" }}
          >
          ...
          >
            QUIÉNES{" "}
            <span style={{ color: "#7DC242" }}>SOMOS</span>
          </h1>
          <p
            className="hf-2 font-light text-white/85 max-w-2xl mx-auto leading-relaxed"
            style={{ fontSize: "1.05rem" }}
          >
            Empresa de consultoría y obras ambientales, forestales y
            agropecuarias comprometida con el desarrollo sostenible de Colombia.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <h2
                className="text-4xl md:text-5xl font-black uppercase tracking-tight leading-none mb-5"
                style={{ color: "#1A2E1A" }}
              >
                ECOAFA{" "}
                <span style={{ color: "#7DC242" }}>S.A.S</span>
              </h2>
              <div
                className="w-14 h-1 mb-7"
                style={{
                  background: "linear-gradient(to right, #7DC242, #00AEEF)",
                }}
              />
              <p className="text-gray-700 text-lg leading-relaxed mb-5">
                ECOAFA S.A.S. nace en el año{" "}
                <strong className="text-gray-900">2007</strong> para darle
                respuesta a las necesidades y problemática ambiental a nivel
                nacional. Actualmente la empresa se ha consolidado como una
                compañía de profesionales especializados en proyectos realizados
                con el sector forestal, ambiental, sanitario y agropecuario
              ...
              <p className="text-gray-500 text-base leading-relaxed mb-9">
                ...
                posicionando su estructura comercial en el mercado nacional con
                más de{" "}
                <strong className="text-gray-700">17 años</strong> de
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-white/80 leading-relaxed text-base">
                Ofrecer soluciones integrales en consultoría y obras ambientales,
                forestales y agropecuarias, contribuyendo al desarrollo sostenible
                de Colombia mediante proyectos de alta calidad técnica, cumpliendo
                con la normatividad ambiental vigente y generando impacto positivo
                en las comunidades y ecosistemas intervenidos.
              </p>
            </div>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                <div
                  className="w-14 h-14 rounded-2xl flex items-center justify-center"
                  style={{
                    background: "linear-gradient(135deg, #00AEEF, #0080B8)",
                  }}
                >
              ...
              <p className="text-white/80 leading-relaxed text-base">
                Consolidarse como una de las empresas líderes en consultoría
                ambiental, forestal y agropecuaria a nivel nacional, reconocida
                por la excelencia técnica, la innovación en sus metodologías y el
                compromiso con la sostenibilidad ambiental y el desarrollo de las
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2
              className="text-5xl font-black uppercase tracking-tight leading-none mb-4"
              style={{ color: "#1A2E1A" }}
            >
              NUESTROS{" "}
              <span style={{ color: "#7DC242" }}>VALORES</span>
            </h2>
            <div
              className="w-16 h-1 mx-auto"
              style={{ background: "linear-gradient(to right, #7DC242, #00AEEF)" }}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {valores.map((v, i) => (
              <div
                ...
                style={{
                  borderColor: "rgba(125,194,66,0.2)",
              ...
              >
                <div
                  ...
                  style={{
                    backgroundColor: "rgba(125,194,66,0.1)",
                    border: "1.5px solid rgba(125,194,66,0.3)",
                  }}
                >
                  {v.icon}
                </div>
                <h3 className="font-black text-gray-800 text-lg uppercase tracking-wide mb-3">
                  {v.title}
                </h3>
      ...
      <section className="py-24" style={{ backgroundColor: "#f0f8f5" }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            >
              EQUIPO{" "}
              <span style={{ color: "#7DC242" }}>ESPECIALIZADO</span>
            </h2>
            <div
              className="w-16 h-1 mx-auto"
              style={{ background: "linear-gradient(to right, #7DC242, #00AEEF)" }}
            ...
            {equipo.map((e, i) => (
              ...
              >
                ...
                <div className="bg-white p-6">
                  <h3 className="font-black text-gray-800 text-lg uppercase tracking-wide mb-2">
                    {e.nombre}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">{e.desc}</p>
                  <div
                    className="mt-4 w-8 h-0.5"
                    style={{
                      background: "linear-gradient(to right, #7DC242, #00AEEF)",
                    }}
                  />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            >
              NUESTRA{" "}
              <span style={{ color: "#7DC242" }}>OFICINA</span>
            </h2>
            <div
              className="w-16 h-1 mx-auto"
              style={{ background: "linear-gradient(to right, #7DC242, #00AEEF)" }}
          ...
          <div className="grid md:grid-cols-5 gap-10 items-start">
            {/* Mapa */}
            <div
              className="md:col-span-3 rounded-3xl overflow-hidden shadow-xl border"
            ...
            <div className="md:col-span-2 flex flex-col gap-5">
              <h3 className="text-2xl font-black text-gray-800 uppercase tracking-wide mb-2">
                Información de{" "}
                <span style={{ color: "#7DC242" }}>Contacto</span>
              </h3>
